...
function Header() {
  return (
    <nav className='flex flex-col items-center justify-center border border-b-1 border-gray-300 p-4 fixed w-[100%] bg-white/20 backdrop-blur-md h-[15vh] shadow-2xl/5'>
